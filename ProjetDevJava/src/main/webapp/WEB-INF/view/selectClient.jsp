							...
							<div class="row no-gutters">
								<div class="col-md-3" style="margin: auto;">
									<img
										...
										class=" rounded mx-auto d-block" alt="photo non renseignée...">
								</div>
								<div class="col-md-7 ">
									<div class="card-body">
										...
										<table class="table-borderless table-striped table-sm ">
											...
											<tr>
												...
												<td class="text-secondary"><c:if
													...
													<c:if test="${empty selectClient.codePostal}">_ _ _ _ _</c:if>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="text-secondary"><c:choose>
														<c:when test="${selectClient.etatCustomer=='C'.charAt(0)}">
															<span class="text-danger">Client</span>
														</c:when>
														<c:when test="${selectClient.etatCustomer=='P'.charAt(0)}">
															<span class="text-warning">Prospect</span>
														</c:when>
														<c:when test="${selectClient.etatCustomer=='F'.charAt(0)}">
								...
								<div class="col-md-2 text-center m-auto">
									...
									<p>
										<a class="btn btn-success btn-sm btn-block"
											href="form?id=${selectClient.id }" role="button">Modifier</a>
									</p>
									<p>
