<nav id="sidebarMenu"
	class="col-md-3 col-lg-2 border-right  d-lg-block collapse ">
...
<!-- 				loading="lazy"><span -->
<!-- 				class=" pl-1 h5  align-middle text-dark ">CRM</span> -->
<!-- 			</a> -->

<!-- 		</div> -->
		<ul class="nav flex-column justify-content-start pt-3 ">
			...
			<li class="nav-item"><a class="nav-link"
				...
				target="_blank"> <span data-feather="Docs"></span> Doc
					Générale
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath }/resources/docs/javadoc/index.html"
				target="_blank"> <span data-feather="Docs"></span>
					Javadoc
			</a></li>
		</ul>
	</div>
